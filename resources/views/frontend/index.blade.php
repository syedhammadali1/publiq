...
<head>
    ...
    <link rel="apple-touch-icon" type="image/x-icon"
        href="{{ asset('frontend/assets/img/img/apple-touch-icon-57x57-precomposed.png') }}">
    <link rel="apple-touch-icon" type="image/x-icon" sizes="72x72"
        href="{{ asset('frontend/assets/img/img/apple-touch-icon-72x72-precomposed.png') }}">
    <link rel="apple-touch-icon" type="image/x-icon" sizes="114x114"
        href="{{ asset('frontend/assets/img/img/apple-touch-icon-114x114-precomposed.png') }}">
    <link rel="apple-touch-icon" type="image/x-icon" sizes="144x144"
        href="{{ asset('frontend/assets/img/img/apple-touch-icon-144x144-precomposed.png') }}">
        ...
        <div class="row row-height">
            <div class="col-lg-6 content-left">
                <div class="content-left-wrapper">
                    <a href="index.html" id="logo"><img src="{{ asset('frontend/assets/img/img/publiq logo.png') }}"
                            alt="" width="108" height="35"></a>
                    <div id="social">
                        <ul>
                    ...
                    <!-- /social -->
                    <div>
                        <figure><img src="{{ asset('frontend/assets/img/login page icon.png') }}" alt=""
                                class="img-fluid"></figure>
                        <ul>
                            <li class="points"><i class="fa fa-check-circle"></i><span> Stay connected with the
                                    world around you!.</span></li>
                            <li class="points"><i class="fa fa-check-circle"></i><span> Making friends is the
                                    easiest thing to do when you’re a member of Pubilq.</span></li>
                            <li class="points"><i class="fa fa-check-circle"></i><span> Meet like-minded people
                                    from your country on this website. </span></li>
                            <li class="points"><i class="fa fa-check-circle"></i><span> Chat with people from
                                    all over the world and share your ideas.</span></li>
                            <li class="points"><i class="fa fa-check-circle"></i><span> You can follow people
                                    and stay connected with there activty.</span></li>
                            <li class="points"><i class="fa fa-check-circle"></i><span> You can Subscribe people
                                    and read their paid & free content</span></li>
                        </ul>
                    </div>
                            ...
                            <div class="step">
                                ...
                                <div class="form-group">
                                    <div class="styled-select clearfix">
                                        <select class="wide @error('country') is-invalid @enderror" name="country">
                            ...
                            <div class="submit step">
                                ...
                                <div class="form-group">
                                    <label class="container_check version_2">Google Search Engine
                                        <input type="checkbox" name="question_2" value="Google Search Engine"
                                            class="@error('question_2') is-invalid @enderror"
                                ...
                                <div class="form-group">
                                    <label class="container_check version_2">Other
                                        <input type="checkbox" name="question_2" value="Other"
                                            class="@error('question_2') is-invalid @enderror"
                                            onchange="getVals(this, 'question_2');">
                                        <span class="checkmark"></span>
                                    </label>
