    ...
    <div class="page-banner-box bg-4">
        ...
        <div class="friends-inner-box-style d-flex justify-content-between align-items-center">
            ...
            <ul class="nav nav-tabs" id="myTab" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" id="all-Following-tab" data-bs-toggle="tab" href="#all-Following" role="tab" aria-controls="all-Following">Following</a>
                </li>

                <li class="nav-item">
                    <a class="nav-link" id="Followers-added-tab" data-bs-toggle="tab" href="#Followers-added" role="tab" aria-controls="Followers-added">Followers</a>
                </li>
            </ul>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-3 col-sm-6">
                        <div class="single-friends-card">
                            <div class="friends-image">
                                <a href="#">
                                    <img src={{ asset("frontend/assets/images/friends/friends-bg-1.jpg") }} alt="image">
                                </a>
                                <div class="icon">
                            ...
                            <div class="friends-content">
                                <div class="friends-info d-flex justify-content-between align-items-center">
                                    <a href="#">
                                        <img src={{ asset("frontend/assets/images/friends/friends-1.jpg") }} alt="image">
                                    </a>
                                    <div class="text ms-3">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="single-friends-card">
                            <div class="friends-image">
                                <a href="#">
                                    <img src={{ asset("frontend/assets/images/friends/friends-bg-2.jpg") }} alt="image">
                                </a>
                                <div class="icon">
                                    <a href="#"><i class="flaticon-user"></i></a>
                                </div>
                            ...
                            <div class="friends-content">
                                <div class="friends-info d-flex justify-content-between align-items-center">
                                    <a href="#">
                                        <img src={{ asset("frontend/assets/images/friends/friends-2.jpg") }} alt="image">
                                    </a>
                                    <div class="text ms-3">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="single-friends-card">
                            <div class="friends-image">
                                <a href="#">
                                    <img src={{ asset("frontend/assets/images/friends/friends-bg-3.jpg") }} alt="image">
                                </a>
                                <div class="icon">
                                    <a href="#"><i class="flaticon-user"></i></a>
                                </div>
                            ...
                            <div class="friends-content">
                                <div class="friends-info d-flex justify-content-between align-items-center">
                                    <a href="#">
                                        <img src={{ asset("frontend/assets/images/friends/friends-3.jpg") }} alt="image">
                                    </a>
                                    <div class="text ms-3">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="single-friends-card">
                            <div class="friends-image">
                                <a href="#">
                                    <img src={{ asset("frontend/assets/images/friends/friends-bg-4.jpg") }} alt="image">
                                </a>
                                <div class="icon">
                                    <a href="#"><i class="flaticon-user"></i></a>
                                </div>
                            ...
                            <div class="friends-content">
                                <div class="friends-info d-flex justify-content-between align-items-center">
                                    <a href="#">
                                        <img src={{ asset("frontend/assets/images/friends/friends-4.jpg") }} alt="image">
                                    </a>
                                    <div class="text ms-3">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="single-friends-card">
                            <div class="friends-image">
                                <a href="#">
                                    <img src={{ asset("frontend/assets/images/friends/friends-bg-5.jpg") }} alt="image">
                                </a>
                                <div class="icon">
                                    <a href="#"><i class="flaticon-user"></i></a>
                                </div>
                            ...
                            <div class="friends-content">
                                <div class="friends-info d-flex justify-content-between align-items-center">
                                    <a href="#">
                                        <img src={{ asset("frontend/assets/images/friends/friends-5.jpg") }} alt="image">
                                    </a>
                                    <div class="text ms-3">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="single-friends-card">
                            <div class="friends-image">
                                <a href="#">
                                    <img src={{ asset("frontend/assets/images/friends/friends-bg-6.jpg") }} alt="image">
                                </a>
                                <div class="icon">
                                    <a href="#"><i class="flaticon-user"></i></a>
                                </div>
                            ...
                            <div class="friends-content">
                                <div class="friends-info d-flex justify-content-between align-items-center">
                                    <a href="#">
                                        <img src={{ asset("frontend/assets/images/friends/friends-6.jpg") }} alt="image">
                                    </a>
                                    <div class="text ms-3">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="single-friends-card">
                            <div class="friends-image">
                                <a href="#">
                                    <img src={{ asset("frontend/assets/images/friends/friends-bg-7.jpg") }} alt="image">
                                </a>
                                <div class="icon">
                                    <a href="#"><i class="flaticon-user"></i></a>
                                </div>
                            ...
                            <div class="friends-content">
                                <div class="friends-info d-flex justify-content-between align-items-center">
                                    <a href="#">
                                        <img src={{ asset("frontend/assets/images/friends/friends-7.jpg") }} alt="image">
                                    </a>
                                    <div class="text ms-3">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="single-friends-card">
                            <div class="friends-image">
                                <a href="#">
                                    <img src={{ asset("frontend/assets/images/friends/friends-bg-8.jpg") }} alt="image">
                                </a>
                                <div class="icon">
                                    <a href="#"><i class="flaticon-user"></i></a>
                                </div>
                            ...
                            <div class="friends-content">
                                <div class="friends-info d-flex justify-content-between align-items-center">
                                    <a href="#">
                                        <img src={{ asset("frontend/assets/images/friends/friends-8.jpg") }} alt="image">
                                    </a>
                                    <div class="text ms-3">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="single-friends-card">
                            <div class="friends-image">
                                <a href="#">
                                    <img src={{ asset("frontend/assets/images/friends/friends-bg-9.jpg") }} alt="image">
                                </a>
                                <div class="icon">
                                    <a href="#"><i class="flaticon-user"></i></a>
                                </div>
                            ...
                            <div class="friends-content">
                                <div class="friends-info d-flex justify-content-between align-items-center">
                                    <a href="#">
                                        <img src={{ asset("frontend/assets/images/friends/friends-9.jpg") }} alt="image">
                                    </a>
                                    <div class="text ms-3">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="single-friends-card">
                            <div class="friends-image">
                                <a href="#">
                                    <img src={{ asset("frontend/assets/images/friends/friends-bg-10.jpg") }} alt="image">
                                </a>
                                <div class="icon">
                                    <a href="#"><i class="flaticon-user"></i></a>
                                </div>
                            ...
                            <div class="friends-content">
                                <div class="friends-info d-flex justify-content-between align-items-center">
                                    <a href="#">
                                        <img src={{ asset("frontend/assets/images/friends/friends-10.jpg") }} alt="image">
                                    </a>
                                    <div class="text ms-3">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="single-friends-card">
                            <div class="friends-image">
                                <a href="#">
                                    <img src={{ asset("frontend/assets/images/friends/friends-bg-11.jpg") }} alt="image">
                                </a>
                                <div class="icon">
                                    <a href="#"><i class="flaticon-user"></i></a>
                                </div>
                            ...
                            <div class="friends-content">
                                <div class="friends-info d-flex justify-content-between align-items-center">
                                    <a href="#">
                                        <img src={{ asset("frontend/assets/images/friends/friends-11.jpg") }} alt="image">
                                    </a>
                                    <div class="text ms-3">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="single-friends-card">
                            <div class="friends-image">
                                <a href="#">
                                    <img src={{ asset("frontend/assets/images/friends/friends-bg-12.jpg") }} alt="image">
                                </a>
                                <div class="icon">
                                    <a href="#"><i class="flaticon-user"></i></a>
                                </div>
                            ...
                            <div class="friends-content">
                                <div class="friends-info d-flex justify-content-between align-items-center">
                                    <a href="#">
                                        <img src={{ asset("frontend/assets/images/friends/friends-12.jpg") }} alt="image">
                                    </a>
                                    <div class="text ms-3">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="single-friends-card">
                            <div class="friends-image">
                                <a href="#">
                                    <img src={{ asset("frontend/assets/images/friends/friends-bg-13.jpg") }} alt="image">
                                </a>
                                <div class="icon">
                                    <a href="#"><i class="flaticon-user"></i></a>
                                </div>
                            ...
                            <div class="friends-content">
                                <div class="friends-info d-flex justify-content-between align-items-center">
                                    <a href="#">
                                        <img src={{ asset("frontend/assets/images/friends/friends-13.jpg") }} alt="image">
                                    </a>
                                    <div class="text ms-3">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="single-friends-card">
                            <div class="friends-image">
                                <a href="#">
                                    <img src={{ asset("frontend/assets/images/friends/friends-bg-14.jpg") }} alt="image">
                                </a>
                                <div class="icon">
                                    <a href="#"><i class="flaticon-user"></i></a>
                                </div>
                            ...
                            <div class="friends-content">
                                <div class="friends-info d-flex justify-content-between align-items-center">
                                    <a href="#">
                                        <img src={{ asset("frontend/assets/images/friends/friends-14.jpg") }} alt="image">
                                    </a>
                                    <div class="text ms-3">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="single-friends-card">
                            <div class="friends-image">
                                <a href="#">
                                    <img src={{ asset("frontend/assets/images/friends/friends-bg-15.jpg") }} alt="image">
                                </a>
                                <div class="icon">
                                    <a href="#"><i class="flaticon-user"></i></a>
                                </div>
                            ...
                            <div class="friends-content">
                                <div class="friends-info d-flex justify-content-between align-items-center">
                                    <a href="#">
                                        <img src={{ asset("frontend/assets/images/friends/friends-15.jpg") }} alt="image">
                                    </a>
                                    <div class="text ms-3">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="single-friends-card">
                            <div class="friends-image">
                                <a href="#">
                                    <img src={{ asset("frontend/assets/images/friends/friends-bg-16.jpg") }} alt="image">
                                </a>
                                <div class="icon">
                                    <a href="#"><i class="flaticon-user"></i></a>
                                </div>
                            ...
                            <div class="friends-content">
                                <div class="friends-info d-flex justify-content-between align-items-center">
                                    <a href="#">
                                        <img src={{ asset("frontend/assets/images/friends/friends-16.jpg") }} alt="image">
                                    </a>
                                    <div class="text ms-3">
