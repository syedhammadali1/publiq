...
<div class="content-page-box-area">
    <div class="page-banner-box bg-3">
        <h3>Help & Support</h3>
    </div>

    <div class="help-and-support-search-box">
        <h3>How can we help you?</h3>

        <form>
            <input type="text" class="input-search" placeholder="Describe your issue...">
            <button type="submit"><i class="ri-search-line"></i></button>
        </form>
    </div>

    <div class="help-and-support-box-content">
        <div class="content">
            <h4>Account Settings</h4>
            <p>Praesent sapien massa convallis pellentesque nec egestas non nisi. Proin eget tortor risus. Quisque velit nisi pretium ut lacinia in elementum id enim. Donec sollicitudin molestie malesuada. Mauris blandit aliquet elit, eget tincidunt nibh pulvinar. Quisque velit nisi pretium ut lacinia in elementum id enim.Donec sollicitudin molestie malesuada. Vivamus suscipit tortor eget felis porttitor volutpat. Mauris blandit aliquet elit eget tincidunt nibh pulvinar. Pellentesque in ipsum id orci porta dapibus. Cras ultricies magna dictum porta. Pellentesque in ipsum id orci porta dapibus.</p>
        </div>
        <div class="content">
            <h4>Legal & Privacy</h4>
