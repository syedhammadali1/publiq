...
<div class="content-page-box-area">
    ...
    <div class="live-chat-slides owl-carousel owl-theme">
        ...
        <div class="chat-box">
            <div class="image">
                <a href="#"><img src={{ asset("frontend/assets/images/user/user-59.jpg") }} class="rounded-circle" alt="image"></a>
                <span class="status-online"></span>
            </div>
            <h3>
                <a href="#">Debra</a>
        ...
        <div class="chat-box">
            <div class="image">
                <a href="#"><img src={{ asset("frontend/assets/images/user/user-60.jpg") }} class="rounded-circle" alt="image"></a>
                <span class="status-online"></span>
            </div>
            <h3>
                <a href="#">Adelina</a>
        ...
        <div class="chat-box">
            <div class="image">
                <a href="#"><img src={{ asset("frontend/assets/images/user/user-39.jpg") }} class="rounded-circle" alt="image"></a>
                <span class="status-online"></span>
            </div>
            <h3>
                <a href="#">Ferrier</a>
        ...
        <div class="live-chat-container">
            <div class="chat-content">
                <div class="chat">
                    <div class="chat-avatar">
                        <a routerLink="/profile" class="d-inline-block">
                            <img src={{ asset("frontend/assets/images/user/user-11.jpg") }} width="50" height="50" class="rounded-circle" alt="image">
                        </a>
                    </div>
                ...
                <div class="chat chat-left">
                    <div class="chat-avatar">
                        <a routerLink="/profile" class="d-inline-block">
                            <img src={{ asset("frontend/assets/images/user/user-2.jpg") }} width="50" height="50" class="rounded-circle" alt="image">
                        </a>
                    </div>
                ...
                <div class="chat">
                    <div class="chat-avatar">
                        <a routerLink="/profile" class="d-inline-block">
                            <img src={{ asset("frontend/assets/images/user/user-3.jpg") }} width="50" height="50" class="rounded-circle" alt="image">
                        </a>
                    </div>
                ...
                <div class="chat chat-left">
                    <div class="chat-avatar">
                        <a routerLink="/profile" class="d-inline-block">
                            <img src={{ asset("frontend/assets/images/user/user-4.jpg") }} width="50" height="50" class="rounded-circle" alt="image">
                        </a>
                    </div>
                ...
                <div class="chat">
                    <div class="chat-avatar">
                        <a routerLink="/profile" class="d-inline-block">
                            <img src={{ asset("frontend/assets/images/user/user-5.jpg") }} width="50" height="50" class="rounded-circle" alt="image">
                        </a>
                    </div>
                ...
                <div class="chat chat-left">
                    <div class="chat-avatar">
                        <a routerLink="/profile" class="d-inline-block">
                            <img src={{ asset("frontend/assets/images/user/user-6.jpg") }} width="50" height="50" class="rounded-circle" alt="image">
                        </a>
                    </div>
                ...
                <div class="chat">
                    <div class="chat-avatar">
                        <a routerLink="/profile" class="d-inline-block">
                            <img src={{ asset("frontend/assets/images/user/user-7.jpg") }} width="50" height="50" class="rounded-circle" alt="image">
                        </a>
                    </div>
                ...
                <div class="chat chat-left">
                    <div class="chat-avatar">
                        <a routerLink="/profile" class="d-inline-block">
                            <img src={{ asset("frontend/assets/images/user/user-8.jpg") }} width="50" height="50" class="rounded-circle" alt="image">
                        </a>
                    </div>
